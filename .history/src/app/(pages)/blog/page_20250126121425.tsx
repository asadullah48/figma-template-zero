            ...
            <div className='w-[70%]'>
                <div className='px-4 mb-8'>
                    ...
                    <div className='flex w-[50%] justify-between'>
                        <p><Image src="/icons/user.png" alt="" /> admin</p>
                        <p><Image className='flex' src="/icons/calender.png" alt="" /> 08 Dec 2024</p>
                        <p><Image className='flex' src="/icons/category.png" alt="" /> Wood</p>
                    </div>
                ...
                <div className='px-4 mb-8'>
                    ...
                    <div className='flex w-[50%] justify-between'>
                        ...
                        <p><Image src="/icons/user.png" alt="" /> admin</p>
                        <p><I className='flex' src="/icons/calender.png" alt="" /> 08 Dec 2024</p>
