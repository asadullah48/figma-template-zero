  ...
  return (
    <div>
      ...
      <div>
        ...
        <div className="relative bg4-center bg4-cover h-[320px] flex flex-col justify-center bg-cover items-center text-center py-10 px-20 bg-[url('/images/instagrambg.pn')]">
